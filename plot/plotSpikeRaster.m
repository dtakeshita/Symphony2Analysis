...
p.addParamValue('FigHandle',gcf,@ishandle);
...
isnonvis = strcmp(get(figH,'visible'),'off');
figure(figH);
hold on;
if isnonvis; set(figH,'visible','off');end;
...
if islogical(spikes)
    ...
    %% DT commented out since it gives error when no spike
